      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/terms" className="text-gray-700 hover:text-blue-600 transition-colors duration-200">TERMS OF SERVICE</Link>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t">
              ...
              <Link to="/terms" className="block px-3 py-2 text-gray-700 hover:text-blue-600">TERMS OF SERVICE</Link>
